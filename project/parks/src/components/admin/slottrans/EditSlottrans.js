                    ...
                    <form onSubmit={updateSlottrans}>
                        <div className="tab-content" id="myTabContent">
                            ...
                            <div className="form-group mb-3">
                                <label>Type ID</label>
                                <input type="text" name="type_id" className="form-control" value={slottransInput.type_id} onChange={handleInput} />
                                <small className="text-danger">{error.type_id}</small>
                            </div>
                            ...
                            <div className="form-group mb-3">
                                <label>Slug</label>
                                <input type="text" name="slug" className="form-control" value={slottransInput.slug} onChange={handleInput} />
                                <small className="text-danger">{error.slug}</small>
                            </div>

                            <div className="form-group mb-3">
                                <label>Status</label>
                                <input type="text" name="status" className="form-control" value={slottransInput.status} onChange={handleInput} />
