            ...
            return (
                <form key={idx} className="form seatfrm">
                    ...
                    {/* <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio"  id="owner" value="Owner" onClick={e => handleGender(e, seat)} />
                        <label class="form-check-label" for="owner">Owner</label>
                    </div>
                      <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio"  id="guest" value="Guest" onClick={e => handleGender(e, seat)} />
                          <label class="form-check-label" htmlFor="guest">Gue</label>
                      </div> */}
                </form>)
